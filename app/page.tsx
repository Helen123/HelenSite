...
export default function Home() {
  ...
  return (
    <div
      className="min-h-screen flex flex-col items-center gap-16 font-capriola-regular"
      style={{ backgroundColor: "#F4F3E8" }}>
      {/* Section 1: Greeting */}
      <section
        className="flex flex-col sm:flex-row items-center justify-center sm:h-auto w-full w-full text-center"
        style={{ backgroundColor: "#F5F374" }}>
        {/* Subsection 1 */}
        <div className="flex flex-col w-full p-20">
          <h1 className="text-4xl sm:text-6xl font-bold text-left text-[#3A4750] capriola-regular">
            Hi, I&#39;m Helen Wu!
          </h1>
      ...
      <section
        id="about-me"
        className="flex flex-col sm:flex-row items-center justify-center min-h-screen sm:h-auto w-full gap-10 p-16">
        ...
        <div className="flex flex-col w-full  gap-8 p-8">
          ...
          <p className="text-lg sm:text-2xl text-left text-[#3A4750] ">
            I&#39;m a fourth-year Computer Science student at UCSB, part of the
            Engineering Honor Program. I&#39;m passionate about software
            development, AI technologies, and building tools that make a
            difference.
          </p>
          <ul className="mt-4 space-y-2 text-lg sm:text-xl">
            <li className="underline text-[#3A4750] ">
              Engineering Honor Program Student
            </li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-[#3A4750] capriola-regular">
            ...
            <div className="flex flex-col items-center rounded-lg shadow-lg p-6">
              ...
              <p className="mt-4 text-left text-gray-600">
                🎵 Built an app for sharing music sheets and videos in the
                Chinese orchestra community. <br />
                🎻 Leveraged UCSB orchestra experience to customize features.{" "}
                <br />
                ⚛️ Used <strong>React Native </strong>for scalability and{" "}
                <strong>Firebase </strong>for auth and storage.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center rounded-lg shadow-lg p-6">
              ...
              <p className="mt-4 text-left text-gray-600">
                📱 Built a travel app for sharing posts and creating plans.{" "}
                <br />
                ⚙️ Used <strong>React Native</strong>, <strong>Expo</strong>,{" "}
                <strong>Firebase</strong>, and <strong>Redux</strong> for
                seamless performance. <br />
                🚀 Led sprints in <strong>Agile</strong>, ensuring efficient
                workflows.
              </p>
              <a
                href="https://drive.google.com/file/d/1G9cf3MkFWdTTOhiRQGYnINRD9oU8pGOn/view?usp=sharing" // Replace with actual video link
                target="_blank"
            ...
            <div className="flex flex-col items-center rounded-lg shadow-lg p-6">
              <Image
                src="/helensite.png" // Replace with actual image path
                alt="Travel Planning Platfrom"
                width={244}
                height={244}
                className="rounded-lg object-cover"
              ...
              <p className="mt-2 text-lg text-[#3A4750]">This Site</p>
              <div className="flex items-center justify-center gap-4">
                <Image
                  src="/rn11.png" // React Native icon URL
                  alt="React Native"
                ...
                />
                <Image
                  src="/nextjs.png" // Firebase icon URL
                  alt="nextjs"
                  width={200}
                  height={200}
                  className="w-20 h-20"
              ...
              <p className="mt-4 text-left text-gray-600">
                ...
                and experiences. <br />
                ⚙️ Developed using <strong>Next.js</strong>,{" "}
                <strong>React</strong>, and <strong>TypeScript</strong> for a
                robust and responsive user experience. <br />
                📧 Integrated <strong>EmailJS</strong> for a seamless contact
                form and <strong>Vercel</strong> for automatic deployments.
              </p>
              <a
                href="https://github.com/Helen123/HelenSite"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-4 text-gray-600 hover:text-gray-800">
      ...
      <section
        id="contact"
        className="flex flex-col sm:flex-row justify-between items-start max-w-screen-lg mx-auto py-12 ">
        ...
        <form
          className="w-full sm:w-1/2 space-y-6 text-[#3A4750] p-8"
      ...
      <footer className="flex flex-col sm:flex-row justify-between items-start mx-auto py-12 w-full p-8">
        ...
        <div className="flex w-full sm:w-3/4 mx-auto">
          <div className="w-1/2 mb-8 sm:mb-0 p-8">
            <h3 className="text-xl font-semibold text-left text-[#3A4750]">
              Explore
            </h3>
            <ul className="mt-4 space-y-2">
              <li>
                <a href="#about-me" className="text-[#3A4750] hover:underline">
                  About me
                </a>
              </li>
              <li>
                <a href="#projects" className="text-[#3A4750] hover:underline">
                  Projects
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#contact" className="text-[#3A4750] hover:underline">
                  Contact
                </a>
              </li>
            </ul>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <p className="text-[#3A4750]">
                  Email:{" "}
                  <a href="mailto:qwu132@ucsb.edu" className="hover:underline">
                    qwu132@ucsb.edu
                  </a>
                </p>
              </li>
